...
export async function generateMetadata({ params }: PropertyDetailProps): Promise<Metadata> {
  ...
  const description = property.seoDescription ||
    ...
    `${property.category} para ${property.type} em ${property.city}, ${property.state}. ${property.bedrooms ? `${property.bedrooms} quartos` : ''} ${property.bathrooms ? `${property.bathrooms} banheiros` : ''} ${property.area ? `${property.area}m²` : ''}. Confira na DCruz Imóveis.`
