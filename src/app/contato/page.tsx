    ...
    <div className="min-h-screen" style={{ backgroundColor: '#ffffff' }}>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* Redes Sociais */}
          {(settings.socialFacebook || settings.socialInstagram || settings.socialTwitter || settings.socialLinkedin) && (
            <div className="bg-white rounded-lg shadow-md p-8 text-center hover:shadow-lg transition-shadow md:col-span-2 lg:col-span-1">
              ...
              <div className="flex justify-center gap-4">
                ...
                {settings.socialLinkedin && (
                  <a href={settings.socialLinkedin} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-blue-700 flex items-center justify-center hover:bg-blue-800 transition-colors">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
